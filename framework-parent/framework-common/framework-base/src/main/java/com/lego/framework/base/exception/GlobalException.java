...
import com.lego.framework.core.exception.*;
...
public class GlobalException {
    ...
    @ResponseStatus(value = HttpStatus.OK)
    @ResponseBody
    public RespVO handleException(UnsatisfiedServletRequestParameterException ex) {
        log.error("参数异常:{}", ex);
        return RespVOBuilder.failure(RespConsts.ParameterError.retCode, ex.getMessage());
    }
