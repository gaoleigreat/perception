package com.lego.framework.eureka.filter;
import com.alibaba.fastjson.JSONObject;

import com.lego.framework.eureka.model.Instance;
...
@WebFilter(filterName = "authFilter", urlPatterns = "/*",initParams = {
        @WebInitParam(name = "black_list",value = "localhost,",description = "blackList")
})
@Order(1)
