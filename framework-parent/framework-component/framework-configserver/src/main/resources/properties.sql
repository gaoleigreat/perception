...
VALUES ('application', 'dev', 'master', 'define.security.name', 'admin');
INSERT INTO properties (application, profile, label, `key`, value)
VALUES ('application', 'dev', 'master', 'define.security.password', '{cipher}a1d30c1325f1b0cd2e4619bff2be57bc32ae0413c0ce1fee07153b60bfa3a782');
INSERT INTO properties (application, profile, label, `key`, value)
...
INSERT INTO properties (application, profile, label, `key`, value)
VALUES ('application', 'dev', 'master', 'eureka.client.serviceUrl.defaultZone', 'http://${define.security.name}:${define.security.password}@192.168.0.86:3306:48010/eureka/');
INSERT INTO properties (application, profile, label, `key`, value)
...
INSERT INTO properties (application, profile, label, `key`, value)
VALUES ('application', 'dev', 'master', 'eureka.instance.metadata-map.security.name', '${define.security.name}');
INSERT INTO properties (application, profile, label, `key`, value)
VALUES ('application', 'dev', 'master', 'eureka.instance.metadata-map.security.password', '${define.security.password}');
INSERT INTO properties (application, profile, label, `key`, value)
...
INSERT INTO properties (application, profile, label, `key`, value)
VALUES ('application', 'dev', 'master', 'spring.boot.admin.client.username', '${define.security.name}');
INSERT INTO properties (application, profile, label, `key`, value)
VALUES ('application', 'dev', 'master', 'spring.boot.admin.client.password', '${define.security.password}');
INSERT INTO properties (application, profile, label, `key`, value)
...
INSERT INTO properties  (application, profile, label, `key`, value)
VALUES ('auth-service', 'dev', 'master', 'jwt.info.name', 'security-api');
INSERT INTO properties  (application, profile, label, `key`, value)
...
INSERT INTO properties  (application, profile, label, `key`, value)
VALUES ('report-service', 'dev', 'master', 'jwt.info.name', 'security-api');
INSERT INTO properties  (application, profile, label, `key`, value)
